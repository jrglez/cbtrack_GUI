function [trxcurr,pred] = TrackTwoFliesOneFrame_GUI(dbkgd,isfore,pred,trxprev,roidata,params)
...
for roii = 1:roidata.nrois,
  ...
  [trxcurr(roii),pred(roii)] = ...
    TrackTwoFliesOneFrameOneROI_GUI(isforebb,dbkgdbb,pred(roii),trxcurr(roii),roidata.nflies_per_roi(roii),params);
