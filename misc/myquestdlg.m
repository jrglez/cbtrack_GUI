...
Interpreter='none';
Question = mydialogCellstrHelper(Question);
...
FigPos(3) = 267;
FigPos(4) =  70;
FigPos    = mygetnicedialoglocation(FigPos, get(0,'DefaultFigureUnits'));
...
if DefaultValid
  mysetdefaultbutton(QuestFig, BtnHandle{DefaultButton});
end
