function varargout=mymsgbox(height,width,fontsize,fontname,varargin)
%MSGBOX Message box.
...
inputStr = varargin{1};
BodyTextString = cellstr(inputStr);
...
OKXOffset=(FigWidth-OKWidth)/2;
DefFigPos(3:4)=[FigWidth FigHeight];
DefFigPos = mygetnicedialoglocation(DefFigPos, get(figureHandle,'Units'));
...
mysetdefaultbutton(figureHandle, OKHandle);
