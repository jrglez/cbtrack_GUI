...
for i=1:length(pff_wmov)
    handles.checkbox_all(i)=uicontrol('Style','checkbox','units','pixels','Position',[uipos_X(i),uipos_Y(i),200,25],'String',pff_wmov(i).name,'FontSize',12,'TooltipString',pff_wmov(i).description,'Value',pff_wmov(i).on);
end
