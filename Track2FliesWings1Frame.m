function [trxcurr,pred,pfdatacurr] = Track2FliesWings1Frame(im,dbkgd,isfore_body,iswing,isfore_wing,pred,trxprev,pffdataprev,roidata,params,Wparams)
...
for roii = 1:roidata.nrois,
  ...
  [trxcurr(roii),pred(roii),pfdatacurr(roii)] = Track2FliesWings1Frame1ROI...
    ...
    fore2bodybb,pred(roii),trxcurr(roii),pfdatacurr(roii),roidata.nflies_per_roi(roii),params,Wparams);
end
