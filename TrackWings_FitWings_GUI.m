function [wingtrx,debugdata] = TrackWings_FitWings_GUI(fore2fly,xgrid_isfore,ygrid_isfore,isfore_thresh,iswing,fore2dbkgd,idxfore_thresh,trx,wingtrxprev,params,debugdata)
...
elseif ~debugdata.DEBUG
  waitbar(debugdata.nframestracked/debugdata.lastframe,debugdata.hwait,['Tracking wings. Frame ', num2str(debugdata.nframestracked),' of ', num2str(debugdata.lastframe)]);    
