...
if find(strcmp(stage,stages)) >= find(strcmp(restartstage,stages)),
    if strcmp(params.assignidsby,'wingsize') && cbparams.track.dotrackwings,
      ...
      if ~params.DEBUG
          debugdata.track=1;
          debugdata.vis=0;
          [wingtrx,wingperframedata,~,wingtrackinfo,wingperframeunits,~] = ...
              TrackWingsHelper_GUI([],trackdata.trx,moviefile,double(bgmed),isarena,params.wingtracking_params,debugdata,...
