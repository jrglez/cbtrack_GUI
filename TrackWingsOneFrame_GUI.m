function [wingtrx,debugdata] = TrackWingsOneFrame_GUI(im,bgmodel,isarena,trxcurr,wingtrxprev,params,XGRID,YGRID,debugdata)
...
[wingtrx,debugdata] = TrackWings_FitWings_GUI(fore2fly,xgrid_isfore,ygrid_isfore,isfore_thresh,iswing,fore2dbkgd,idxfore_thresh,trxcurr,wingtrxprev,params,debugdata);
