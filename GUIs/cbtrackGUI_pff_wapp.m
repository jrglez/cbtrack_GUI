...
for i=1:length(pff_wapp)
    handles.checkbox_all(i)=uicontrol('Style','checkbox','units','pixels','Position',[uipos_X(i),uipos_Y(i),200,25],'String',pff_wapp(i).name,'FontSize',12,'TooltipString',pff_wapp(i).description,'Value',pff_wapp(i).on);
end
