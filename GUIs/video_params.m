...
uiset_tip={'Make results movie.';'Frames per second.';'Frames per second.';...
    'Zoom flies.';'Zoom flies.';'Number of rows to display zoomed flies.';...
    'Number of rows to display zoomed flies.';'Number of columns to display zoomed flies.';...
    'Number of columns to display zoomed flies.';'Zoom scale.';'Zoom scale.';...
    'Zoom scale.';'Display trajectory in previous frames';'Number of previous frames.';...
    'Number of frames in each part of the video.';'Number of frames form the initial part.';...
    'Number of frames form the initial part.';'Number of frames form the midle part.';...
    'Number of frames form the midle part.';'Number of frames form the final part.';...
    'Number of frames form the final part.';'Video size.';'Video width.';...
    'Video width.';'Video height.';'Video height.';'Select flies manually.';...
    'Start selecting flies.';'Undo.';'Cancel selection'};
