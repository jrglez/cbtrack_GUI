function varargout = cbtrackGUI_ROI_queue(varargin)
...
%      applied to the GUI before cbtrackGUI_ROI_queue_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to cbtrackGUI_ROI_queue_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 06-Mar-2014 17:48:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cbtrackGUI_ROI_queue_OpeningFcn, ...
                   'gui_OutputFcn',  @cbtrackGUI_ROI_queue_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function cbtrackGUI_ROI_queue_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = cbtrackGUI_ROI_queue_OutputFcn(hObject, eventdata, handles) 
...
function pushbutton_cancel_Callback(hObject, eventdata, handles)%#ok<*INUSD,*DEFNU>
