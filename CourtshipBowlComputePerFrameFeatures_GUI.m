...
if isempty(perframefns),
  if ~isempty(perframe_params.perframefns) && cbparams.track.dotrack
    ...
    if ~cbparams.track.dotrackwings
        wingfns = {'angle_biggest_wing';'angle_smallest_wing';'area_inmost_wing';...
            'area_outmost_wing';'dangle_biggest_wing';'dangle_smallest_wing';...
            'darea_inmost_wing';'darea_outmost_wing';'dmax_wing_angle';...
            'dmax_wing_area';'dmin_wing_angle';'dmin_wing_area';...
            'dnwingsdetected';'dwing_angle_diff';'dwing_angle_imbalance';...
            'max_absdwing_angle';'max_absdwing_area';'max_dwing_angle_in';...
            'max_dwing_angle_out';'max_wing_angle';'max_wing_area';...
            'mean_wing_angle';'mean_wing_area';'min_wing_angle';...
            'min_absdwing_angle';'min_absdwing_area';'min_dwing_angle_in';...
            'min_dwing_angle_out';'min_wing_angle';'min_wing_area';...
            'nwingsdetected';'wing_angle_diff';'wing_angle_imbalance'};
